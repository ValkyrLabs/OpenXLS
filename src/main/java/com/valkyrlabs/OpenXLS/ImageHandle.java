...
public class ImageHandle implements Serializable{
    ...
    private void initialize() {
    	...
    	try{
    		...
    		Logger.logWarn("Problem creating ImageHandle:" + e.toString() + " Please see BugTrack article: http://valkyrlabs.com/uimodules/docs/docs_detail.jsp?meme_id=1431&showall=true");
