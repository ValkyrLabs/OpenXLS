...
public class BlockByteReader implements Serializable {
    ...
    public byte[] getHeaderBytes(int startpos) {
        try {
            ...
            throw new WorkBookException("Smallblock based workbooks are unsupported in OpenXLS: see http://valkyrlabs.com/uimodules/docs/docs_detail.jsp?showall=true&meme_id=195", WorkBookException.SMALLBLOCK_FILE);
        }
    }
